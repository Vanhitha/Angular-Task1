...
activeTab = 'Students';
 stats = [ { value: 28, label: 'Emergency' },
...
// 	  color: 'line-danger',
// 	  users: [
// 		'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYl7CQiVBu1s50pldzBpDxAl_QzBtTRSxxiaibaHAkpQ&s&ec=121629545',
// 		'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYl7CQiVBu1s50pldzBpDxAl_QzBtTRSxxiaibaHAkpQ&s&ec=121629545'
// 	  ]
// 	}
//   ];
...
// 	  leave: '12 - 13 May',
// 	  image: 'https://img.freepik.com/premium-photo/corporate-young-boy-office-keep-smiling_585255-2631.jpg?w=996'
// 	},
// 	{
// 	  name: 'Ramien',
// 	  type: 'Casual',
...
// 	  image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSARGs46NmwJrtWhTMUX2mNEFVlLtJuOVAkEldZdwZHlQ&s&ec=121629545'
// 	},
// 	{
// 	  title: 'Participated in "Carrom"',
// 	  desc: 'Justin Lee participated in "Carrom"',
// 	  image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYl7CQiVBu1s50pldzBpDxAl_QzBtTRSxxiaibaHAkpQ&s&ec=121629545'
// 	},
// 	{
...
// 	  desc: 'We attended international conference',
// 	  image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYl7CQiVBu1s50pldzBpDxAl_QzBtTRSxxiaibaHAkpQ&s&ec=121629545'
// 	}
//   ];
//   tasks = [
// 	{ title: 'Send Reminder to Students', time: '01:00 PM', status: 'Completed', completed: true },
// 	{ title: 'Create Routine to new staff', time: '04:50 PM', status: 'Inprogress', completed: false },
// 	{ title: 'Extra Class Info to Students', time: '04:55 PM', status: 'Yet To Start', completed: false },
// 	{ title: 'Fees for Upcoming Academics', time: '04:55 PM', status: 'Yet To Start', completed: false },
// 	{ title: 'English - Essay on Visit', time: '05:55 PM', status: 'Yet To Start', completed: false }
//   ];

//   ngAfterViewInit(): void {
// 	this.ininitAttendanceChart();
// 	this.loadFeesChart();
// 	this.loadEarningsChart();
// 	this.loadExpensesChart();
//   }

//   ininitAttendanceChart(): void {
